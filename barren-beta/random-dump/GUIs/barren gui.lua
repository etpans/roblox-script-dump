...
--Category (Left side bar) > Sector (Title) > Cheats (Buttons and stuff)

--malicious
local malcategory = win:Category("Malicious")

local malsec = malcategory:Sector("Gun Modifications")
malsec:Cheat("Checkbox", "Infinite Ammo", function(InfAmmoEnabled)
  if InfAmmoAnabled then
    --script
  end
end)

malsec:Cheat("Checkbox", "Rage Mode", function(RageModeEnable)

end)

malsec:Cheat("Checkbox", "No Recoil", function(NoRecoilEnable)

end)

malsec:Cheat("Checkbox", "No Spread", function(NoSpreadEnable)

end)

malsec:Cheat("Checkbox", "Fire Rate", function(FireRateEnable)

end)

malsec:Cheat("Slider", "Fire Rate", function(FireRateValue)
...
-- airdrop esp block esp fullbright hitbox head and body
...
local missec = miscategory:Sector("Miscellaneous")
--insta kill heli auto change clothes auto eat duping reset w/ keybind
...
cresec:Cheat("Button", " UI Library by detorious#1153", function()
