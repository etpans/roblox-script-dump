--[[
    SimpleSpy v0.9 SOURCE 

    Credits: 
        exxtremestuffs - basically everything
        Frosty - GUI to Lua
	Pans - GUI Cursor & optimization 
]]
...
titleLabel.Text = "SimpleSpy v0.8"
...
newButton(
    ...
    function(button)
        ...
        codebox.Text = "(getgc) Function #" .. tostring(selected.FunNum) .. "\n\n" .. selected.Upvalues
