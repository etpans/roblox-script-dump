            ...
            function section:Cheat(kind, name, tip, callback, data)
                ...
                if kind then
                    if string.lower(kind) == "toggle" then
                        ...
                        cheat.toggle_corner = kavo:Create("UICorner", {
                            Name = "ToggleCorner",
                            CornerRadius = UDim.new(0, 4)
                        })
                        cheat.toggle_corner.Parent = cheat.toggle

                        cheat.toggle_disabled = kavo:Create("ImageLabel", {
                            Name = "ToggleDisabled",
                            BackgroundTransparency = 1,
                        ...
                        cheat.toggle_disabled.Parent = cheat.toggle

                        cheat.toggle_enabled = kavo:Create("ImageLabel", {
                            Name = "ToggleEnabled",
                            BackgroundTransparency = 1,
                            Image = "rbxassetid://3926309567",
                            ImageColor3 = themeList.SchemeColor,
                        ...
                        cheat.toggle_enabled.Parent = cheat.toggle

                        cheat.toggle_label = kavo:Create("TextLabel", {
                            Name = "ToggleName",
                            BackgroundTransparency = 1,
                            Font = Enum.Font.GothamSemibold,
                        ...
                        cheat.toggle_label.Parent = cheat.toggle
                        cheat.toggle_label.RichText = true
                        ...
                        cheat.information_button.Parent = cheat.toggle

                        cheat.toggle_animation = kavo:Create("ImageLabel", {
                        ...
                        cheat.toggle_animation.Parent = cheat.toggle
                        ...
                        cheat.toggle.MouseButton1Click:Connect(function()
                            if not focusing then
                                ...
                                if cheat.value then
                                    kavo.gs["TweenService"]:Create(cheat.toggle_enabled, TweenInfo.new(0.11, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                                        ImageTransparency = 0
                                    }):Play()
                                    local clone = cheat.toggle_animation:Clone()
                        ...
                        coroutine.wrap(function()
                            while wait() do
                                ...
                                cheat.toggle_disabled.ImageColor3 = themeList.SchemeColor
                                cheat.toggle_enabled.ImageColor3 = themeList.SchemeColor
                                cheat.toggle_label.TextColor3 = themeList.TextColor
                                cheat.information_button.ImageColor3 = themeList.SchemeColor
                                cheat.toggle_animation.ImageColor3 = themeList.SchemeColor
                    ...
                    elseif string.lower(kind) == "colorpicker" then
                        ...
                        cheat.colorpicker_header = kavo:Create("Frame", {
                            Name = "ColorPickerHeader",
                            BackgroundColor3 = themeList.ElementColor,
                            ClipsDescendants = true,
                            Size = UDim2.new(0, 352, 0, 33)
                        }, UDim.new(0, 4))
                        cheat.colorpicker_header.Parent = cheat.colorpicker

                        cheat.colorpicker_icon = kavo:Create("ImageLabel", {
                        ...
                        cheat.colorpicker_icon.Parent = cheat.colorheader

                        cheat.colorpicker_label = kavo:Create("TextLabel", {
                        ...
                        cheat.colorpicker_label.RichText = true
                        cheat.colorpicker_label.Parent = cheat.colorpicker_header
                        ...
                        cheat.current_color = kavo:Create("Frame", {
                            Name = "CurrentColor",
                            BackgroundColor3 = themeList.ElementColor,
                            Position = UDim2.new(0, 0, 0.255319148, 0),
                            Size = UDim2.new(0, 352, 0, 105)
                        }, UDim.new(0, 4))
                        cheat.current_color.Parent = cheat.headerr

                        cheat.colorpicker_layout = kavo:Create("UIListLayout", {
                            Name = "ColorPickerLayout",
                            Padding = UDim.new(0, 3),
                            SortOrder = Enum.SortOrder.LayoutOrder
                        })
                        cheat.colorpicker_layout.Parent = cheat.colorpickercorner
                    ...
                    elseif string.lower(kind) == "button" then
                        ...
                        cheat.button_label = kavo:Create("TextLabel", {
                            Name = "ButtonLabel",
                            BackgroundTransparency = 1,
                            Font = Enum.Font.GothamSemibold,
                            Position = UDim2.new(0.096704483, 0, 0.272727281, 0),
                        ...
                        cheat.button_label.RichText = true
                        cheat.button_label.Parent = cheat.button
                        ...
                        cheat.information_button.Parent = cheat.button

                        cheat.button_icon = kavo:Create("ImageLabel", {
                            Name = "ButtonIcon",
                            BackgroundTransparency = 1,
                            Image = "rbxassetid://3926305904",
                            ImageColor3 = themeList.Schemecolor,
                        ...
                        cheat.button_icon.Parent = cheat.button

                        cheat.button_animation = kavo:Create("ImageLabel", {
                        ...
                        cheat.button_animation.Parent = cheat.button
                        ...
                        cheat.button.MouseButton1Click:Connect(function()
                            if not focusing then
                                callback()
                                local clone = cheat.button_animation:Clone()
                        ...
                        coroutine.wrap(function()
                            while wait() do
                                ...
                                cheat.information_button.ImageColor3 = themeList.SchemeColor
                                cheat.button_animation.ImageColor3 = themeList.SchemeColor
                                cheat.information.BackgroundColor3 = Color3.fromRGB(themeList.SchemeColor.r * 255 - 14, themeList.SchemeColor.g * 255 - 17, themeList.SchemeColor.b * 255 - 13)
                                cheat.information.TextColor3 = themeList.TextColor
                                cheat.button_icon.ImageColor3 = themeList.SchemeColor
                                cheat.button_label.TextColor3 = themeList.TextColor
                            end
                        end)()
                    ...
                    elseif string.lower(kind) == "keybind" then
                        ...
                        cheat.keybind_label = kavo:Create("TextLabel", {
                            Name = "KeybindLabel",
                            BackgroundTransparency = 1,
                            Font = Enum.Font.GothamSemibold,
                            Position = UDim2.new(0.096704483, 0, 0.272727281, 0),
                        ...
                        cheat.keybind_label.RichText = true
                        cheat.keybind_label.Parent = cheat.keybind
                        ...
                        cheat.keybind_icon = kavo:Create("ImageLabel", {
                            Name = "KeybindIcon",
                            BackgroundTransparency = 1,
                            Image = "rbxassetid://3926305904",
                            ImageColor3 = themeList.SchemeColor,
                        ...
                        cheat.keybind_icon.Parent = cheat.keybind
                        ...
                        cheat.keybind_animation = kavo:Create("ImageLabel", {
                        ...
                        cheat.keybind_animation.Parent = cheat.keybind
                        ...
                        cheat.keybind.MouseButton1Click:Connect(function()
                            if not focusing then
                                ...
                                if a.KeyCode.Name ~= "Unknown" and Input.KeyCode ~= kavData.ToggleKey and Input.KeyCode ~= Enum.KeyCode.Backspace then
                                    firstcheck = true
                                    cheat.keybind_label = a.KeyCode.Name
                                    callback_bind = a.KeyCode.Name
                                end

                                local clone = cheat.keybind_animation:Clone()
                        ...
                        coroutine.wrap(function()
                            while wait() do
                                ...
                                cheat.keybind_label.TextColor3 = themeList.SchemeColor
                                cheat.keybind_icon.ImageColor3 = themeList.SchemeColor
                                viewInfo.ImageColor3 = themeList.SchemeColor
                                cheat.keybind_label.BackgroundColor3 = themeList.TextColor
                                cheat.keybind_label.TextColor3 = themeList.TextColor
                                cheat.keybind_animation.ImageColor3 = themeList.SchemeColor
                                cheat.information.TextColor3 = themeList.TextColor
                                cheat.information.BackgroundColor3 = Color3.fromRGB(themeList.SchemeColor.r * 255 - 14, themeList.SchemeColor.g * 255 - 17, themeList.SchemeColor.b * 255 - 13)
                            end
                        end)()
                    ...
                    elseif string.lower(kind) == "label" then
                        ...
                        cheat.label.Parent = self2.container
