...
function Kavo.CreateLib(kavName, themeList)
    ...
    local ScreenGui = Instance.new("ScreenGui") --userinterface
    local Main = Instance.new("Frame") --container
    local MainCorner = Instance.new("UICorner") --containercorner
    local MainHeader = Instance.new("Frame") --header
    local headerCover = Instance.new("UICorner") --headercorner
    local coverup = Instance.new("Frame") --headercover
    local title = Instance.new("TextLabel") --title
    local close = Instance.new("ImageButton") --close
    local MainSide = Instance.new("Frame") --sidebar
    local sideCorner = Instance.new("UICorner") --sidebarcorner
    local coverup_2 = Instance.new("Frame") --sidebarcover
    local tabFrames = Instance.new("Frame") --categories
    local tabListing = Instance.new("UIListLayout") --categorylayout
    local pages = Instance.new("Frame") --pages
    local infoContainer = Instance.new("Frame") --infocontainer
    local blurFrame = Instance.new("Frame") --blurframe
    ...
    close.MouseButton1Click:Connect(function()
        local closetween = game:GetService("TweenService"):Create(Main, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
    ...
    function Tabs:NewTab(tabName)
        ...
        local tabButton = Instance.new("TextButton") --category.button
        local UICorner = Instance.new("UICorner") --category.categorycorner
        local page = Instance.new("ScrollingFrame") --category.page
        local pageListing = Instance.new("UIListLayout") --category.pagelayout
        ...
        function Sections:NewSection(secName, hidden)
            ...
            local sectionFrame = Instance.new("Frame") --section.page
            local sectionlistoknvm = Instance.new("UIListLayout") --section.pagelayout
            local sectionHead = Instance.new("Frame") --section.header
            local sHeadCorner = Instance.new("UICorner") --section.headercorner
            local sectionName = Instance.new("TextLabel") --section.name
            local sectionInners = Instance.new("Frame") --section.container
            local sectionElListing = Instance.new("UIListLayout") --section.containerlayout
            ...
            function Elements:NewButton(bname, tipINf, callback)
                ...
                local buttonElement = Instance.new("TextButton") --cheat.button
                local UICorner = Instance.new("UICorner") --cheat.buttoncorner
                local btnInfo = Instance.new("TextLabel") --cheat.buttonlabel
                local viewInfo = Instance.new("ImageButton") --cheat.informationbutton
                local touch = Instance.new("ImageLabel") --cheat.buttonicon
                local Sample = Instance.new("ImageLabel") --cheat.buttonanimation
                local moreInfo = Instance.new("TextLabel") --cheat.information
                local UICorner = Instance.new("UICorner") --cheat.informationcorner
            ...
            function Elements:NewToggle(tname, nTip, callback, data)
                local TogFunction = {}
                ...
                local toggleElement = Instance.new("TextButton") --cheat.toggle
                local UICorner = Instance.new("UICorner") --cheat.togglecorner
                local toggleDisabled = Instance.new("ImageLabel") --cheat.toggledisabled
                local toggleEnabled = Instance.new("ImageLabel") --cheat.toggleenabled
                local togName = Instance.new("TextLabel") --cheat.togglelabel
                local viewInfo = Instance.new("ImageButton") --cheat.informationbutton
                local Sample = Instance.new("ImageLabel") --cheat.toggleanimation
                local moreInfo = Instance.new("TextLabel") --cheat.information
                local UICorner = Instance.new("UICorner") --cheat.informationcorner
            ...
            function Elements:NewKeybind(keytext, keyinf, first, callback)
                ...
                game:GetService("UserInputService").InputBegan:Connect(function(Input, Process)
                    if not Process and Input.KeyCode.Name == oldKey then
